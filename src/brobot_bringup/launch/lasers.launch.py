...
def generate_launch_description():
    ydlidar_config_path = PathJoinSubstitution(
        [FindPackageShare("brobot_bringup"), "config", "ydlidar.yaml"]
    )

    return LaunchDescription(
        [
            DeclareLaunchArgument(
                name="sensor", default_value="ydlidar", description="Sensor to launch"
            ),
            DeclareLaunchArgument(
                name="topic_name", default_value="scan", description="Laser Topic Name"
            ),
            DeclareLaunchArgument(
                name="frame_id", default_value="laser", description="Laser Frame ID"
            ),
            Node(
