...
class color_identify:
    def __init__(self):
        ...
        # self.n = rospy.init_node('arm_identify', anonymous=True)
    ...
    def get_Sqaure(self, color_hsv):
        ...
        for i, cnt in enumerate(contours):
            ...
            if area > 1000:
                ...
                # 计算方块在图像中的位置
                # (a, b) = (round(((point_x - 320) / 4000)-0.0025, 5), round(((480 - point_y) / 3000) * 0.8+0.10, 5))
                # (a, b) = (round(((point_x - 320) / 4000)-0.0025, 5), round(0.17-((point_y-240) / 3000 * 0.8), 5))
                a = round(((point_x - 320) / 4000)-0.0025, 5)
                b = round(0.175-((point_y-240) / 3000 * 0.8), 5)
                angle = -math.atan2(a, b)*57.3*0.5
                # print("block:", point_x, point_y, a, b, angle)
                return (a, b, angle)
