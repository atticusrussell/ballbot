...
class Color_Grab:
    def __init__(self):
        ...
        self.look_at = self.robot.P_LOOK_AT
        self.p_top = self.robot.P_TOP

        self.p_Yellow = self.robot.P_YELLOW
        self.p_Red = self.robot.P_RED

        self.p_Green = self.robot.P_GREEN
        self.p_Blue = self.robot.P_BLUE

        self.p_gray = self.robot.P_CENTER
