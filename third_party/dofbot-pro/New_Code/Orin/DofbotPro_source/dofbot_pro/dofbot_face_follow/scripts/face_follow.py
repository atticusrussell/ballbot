...
class Face_Follow:
    def __init__(self):
        ...
        haar_path = "/home/jetson/dofbot_pro/dofbot_face_follow/scripts/haarcascade_frontalface_default.xml"
        print("haar_path:", haar_path)
        self.faceDetect = cv.CascadeClassifier(haar_path)
...
if __name__ == '__main__':
    ...
    try:
        while capture.isOpened():
            ...
            fps.update_fps()
            img, pos = face.follow_function(frame)
            # if pos is not None:
