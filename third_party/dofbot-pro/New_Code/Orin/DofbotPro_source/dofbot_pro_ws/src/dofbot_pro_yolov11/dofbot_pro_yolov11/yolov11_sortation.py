...
class Yolov11GraspNode(Node):
    def __init__(self):
        ...
        self.init_joints = [90.0, 110.0, 0.0, 0.0, 90.0, 30.0]
        ...
        self.Arm.Arm_serial_servo_write6(90.0, 110.0, 0.0, 0.0, 90.0, 30.0,2000)
    ...
    def move(self):
        ...
        self.Arm.Arm_serial_servo_write6(90.0, 120.0, 0.0, 0.0, 90.0, 140.0,2000)
        time.sleep(2.5)
        ...
        if self.name in self.recyclable_waste:
            ...
            self.set_joint = [140, 45, 90, 3, 50.0,140]
            ...
            self.set_joint = [165, 50, 60, 2, 90.0,140]
            ...
            self.set_joint = [35, 38, 90, 2, 90.0,140]            
            ...
            self.set_joint = [12, 50, 60, 0, 90.0,140]
        ...
        time.sleep(2.5)
        self.Arm.Arm_serial_servo_write(2, 70, 2000)
        time.sleep(2.5)
